...
- Name the task "Deploy AS model using Tabular Editor". Use the following script: `start /wait TabularEditor.exe "$(Build.SourcesDirectory)\AdventureWorks\Database.json" -D "$(ASConnectionString)" "$(ASDatabase)" -O -C -P -R -M -W -E -V`
