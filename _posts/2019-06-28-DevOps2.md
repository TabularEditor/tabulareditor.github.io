...
Complete the pull request. By default, this will delete the feature branch and complete the work items linked to it, upon completion. As you will see in the [next chapter](https://tabulareditor.github.io/2019/10/08/DevOps3.html), we will use build pipelines to ensure that everything builds succesfully, before a pull request is completed.
